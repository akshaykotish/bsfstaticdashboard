...
import { 
  ...
  FileText, Briefcase, CreditCard, PieChart, Database,
  Activity, Heart, Gauge, PauseCircle, PlayCircle, Eye,
...
const DataTable = ({ 
  ...
  const [selectedColumns, setSelectedColumns] = useState([
    ...
    'remaining_amount', 'calculated_time_allowed'
  ]);
  ...
  const columns = [
    ...
    { key: 'remaining_amount', label: 'Remaining', width: '120px', align: 'right', format: 'currency' },
          ...
          <tbody className={`divide-y ${darkMode ? 'divide-gray-700' : 'divide-gray-200'}`}>
            {paginatedData.map((row, index) => (
              <React.Fragment key={row.id || row.serial_no || index}>
                ...
                {/* Expanded Row Details - Updated with new fields */}
                {expandedRows.includes(row.id || row.serial_no || index) && (
                  <tr>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                          ...
                          <div className={`p-4 rounded-xl ${darkMode ? 'bg-gray-800' : 'bg-white'} border ${darkMode ? 'border-gray-700' : 'border-gray-200'}`}>
                            ...
                            <dl className="space-y-2">
                              ...
                              <div className="flex justify-between items-center pt-2 border-t border-gray-200 dark:border-gray-700">
                                <dt className="text-xs font-semibold text-gray-600 dark:text-gray-400">Calculated Time:</dt>
                          ...
                          <div className={`p-4 rounded-xl ${darkMode ? 'bg-gray-800' : 'bg-white'} border ${darkMode ? 'border-gray-700' : 'border-gray-200'}`}>
                            ...
                            <dl className="space-y-2">
                              ...
                              <div className="flex justify-between">
                                <dt className="text-xs text-gray-600 dark:text-gray-400">Time Allowed:</dt>
